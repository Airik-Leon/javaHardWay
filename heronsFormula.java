public class heronsFormula{
  ...
  public static double triangleArea(int a, int b, int c){
    ...
    //Arter computing the area, you must 'return' the computed value:
    return A;
  }

  //1. The version without functions is longer
  //2. It would have required the user to make updates to each triangleArea
  // since there is no formula.
  //3. No not difficult to add to the problem with functions
  //Would of had to repeat all of the statements to have the same desired functions. 
}
